...
class CuraEnginePostprocessPluginConan(ConanFile):
    name = "curaengine_plugin_postprocess"
    description = "CuraEngine plugin for testing the postprocess slot"
    license = "agpl-3.0"
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "https://github.com/Ultimaker/CuraEngine_plugin_postprocess"
    ...
    def requirements(self):
        ...
        self.requires("curaengine_grpc_definitions/latest@ultimaker/cura_10805")
